...
function subtrair() {
  ...
  /* use as constantes numero 1 e numero 2 e realize a substração entre elas.
   Em seguida, ao invés de mostrar o numero 9, mostre o resultado da operação */
  
  const substracao = numero1 - numero2
  
  
  
  
  document.getElementById("resultadoSub").innerHTML = substracao;
}
